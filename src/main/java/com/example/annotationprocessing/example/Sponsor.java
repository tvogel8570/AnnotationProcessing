...
public class Sponsor implements Serializable {
	...
	public static final class SponsorBuilder {
		private Long id;
		private Integer version;
		private @NotBlank @Length(max = 15) String sponsorType;
		private @NotBlank @Length(max = 50) String sponsorName;
		private @NotBlank @Length(max = 50) String sailingVenue;
		...
		public SponsorBuilder withCity(String city) {
			this.city = city;
			return this;
		}
